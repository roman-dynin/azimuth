...
<template>
  <div class="px-4 pt-4 pb-2">
    <div class="mb-2 flex items-center justify-between">
      <span class="text-xs tracking-wide text-gray-400 uppercase">Маршруты</span>
      <button
    ...
    <div
      ...
      :key="route.id"
      class="flex items-center justify-between py-1.5 text-gray-300"
    >
      <div
        class="min-w-0 flex-1 cursor-pointer hover:text-white"
      ...
      <button
        class="ml-2 shrink-0 cursor-pointer text-xs text-gray-500 hover:text-white"
